...
public class Controlador {
    ...
    public List<Cliente> getClientes() { return modelo.getCliente(); }
    ...
    public List<Revision> getRevisionesClientes(Cliente cliente) { return modelo.getRevisiones(cliente);}

    public List<Revision> getRevisionesVehiculos(Vehiculo vehiculo) { return modelo.getRevisiones(vehiculo);}
}
