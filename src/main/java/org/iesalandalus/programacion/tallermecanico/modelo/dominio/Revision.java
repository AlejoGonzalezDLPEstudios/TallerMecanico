...
public class Revision {
    ...
    private void setFechaInicio(LocalDate fechaInicio) {
        ...
        if (fechaInicio.isAfter(LocalDate.now())) {
            throw new IllegalArgumentException("La fecha de inicio no puede ni debe ser futura");
        }
    ...
    public void anadirHoras(int horas) throws TallerMecanicoExcepcion {
        if (horas <= 0) {
            throw new IllegalArgumentException("Las horas a añadir deben de ser mayores a 0");
        }
        if (estaCerrada()) {
            throw new TallerMecanicoExcepcion("No se puede añadir horas, ya que la revision esta cerrada");
        }
    ...
    public void anadirPrecioMaterial(float precioMaterial) throws TallerMecanicoExcepcion {
        if (precioMaterial <= 0) {
            throw new IllegalArgumentException(("El precio del material a añadir debe de ser mayor a 0"));
        }
        if (estaCerrada()) {
            throw new TallerMecanicoExcepcion("No se puede añadir precio del material, ya que la revision esta cerrada");
        }
    ...
    public boolean equals(Object o) {
     ...
     return Objects.equals(cliente, revision.cliente) && Objects.equals(vehiculo, revision.vehiculo) && Objects.equals((fechaInicio), revision.fechaInicio) && Objects.equals(fechaFin, revision.fechaFin);
    }
